 ...
 */
public class ContinuousFileProcessingITCase_RestartInjected extends AbstractTestBaseJUnit4 {
    ...
    public void testProgram() throws Exception {
        ...
        RestartFramework.at("before_file_processing_execute")
        ...
        RestartFramework.at("during_file_processing")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
