 ...
 * HDFS.
 */
public class DistributedCacheDfsTest_RestartInjected extends TestLogger {
    ...
    public void testDistributedFileViaDFS() throws Exception {
        ...
        RestartFramework.at("before_dfs_execute")
        ...
        RestartFramework.at("during_dfs_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSubmittingJobViaRestClusterClient() throws Exception {
        ...
        RestartFramework.at("before_rest_client_submit")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        java.util.concurrent.CompletableFuture<JobResult> jobResultFuture =
                restClusterClient
                        .submitJob(jobGraph)
                        .thenCompose(restClusterClient::requestJobResult);

        RestartFramework.at("during_rest_client_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
