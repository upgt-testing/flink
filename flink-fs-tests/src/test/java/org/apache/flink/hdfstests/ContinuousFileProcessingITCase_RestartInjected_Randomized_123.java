 ...
 */
public class ContinuousFileProcessingITCase_RestartInjected_Randomized_123 extends AbstractTestBaseJUnit4 {
    ...
    public void testProgram() throws Exception {
        ...
        RestartFramework.at("during_file_processing").on(MINI_CLUSTER_RESOURCE).restart("taskmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        ...
        RestartFramework.at("before_file_processing_execute").on(MINI_CLUSTER_RESOURCE).restart("jobmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
