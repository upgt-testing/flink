...
public class AvroOutputFormatITCase_RestartInjected extends JavaProgramTestBaseJUnit4 {
    ...
    protected void testProgram() throws Exception {
        ...
        RestartFramework.at("before_avro_execute")
        ...
        RestartFramework.at("during_avro_sink_write")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
