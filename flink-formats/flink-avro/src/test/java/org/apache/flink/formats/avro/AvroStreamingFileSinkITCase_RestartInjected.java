...
public class AvroStreamingFileSinkITCase_RestartInjected extends AbstractTestBaseJUnit4 {
    ...
    public void testWriteAvroSpecific() throws Exception {
        ...
        RestartFramework.at("before_avro_specific_execute")
        ...
        RestartFramework.at("during_avro_specific_write")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testWriteAvroGeneric() throws Exception {
        ...
        RestartFramework.at("before_avro_generic_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("during_avro_generic_write")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testWriteAvroReflect() throws Exception {
        ...
        RestartFramework.at("before_avro_reflect_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("during_avro_reflect_write")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
