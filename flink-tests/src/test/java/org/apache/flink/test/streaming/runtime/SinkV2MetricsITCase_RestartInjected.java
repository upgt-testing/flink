...
public class SinkV2MetricsITCase_RestartInjected extends TestLogger {
    ...
    public void testCommitterMetrics() throws Exception {
        ...
        RestartFramework.at("after_committer_job_submit")
            .on(miniClusterResource)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("during_committer_execution")
            .on(miniClusterResource)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
