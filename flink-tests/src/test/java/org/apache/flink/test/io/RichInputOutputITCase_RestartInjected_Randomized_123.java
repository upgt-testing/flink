 ...
 * accumulator values.
 */
public class RichInputOutputITCase_RestartInjected_Randomized_123 extends JavaProgramTestBaseJUnit4 {
    ...
    protected void testProgram() throws Exception {
        ...
        env.createInput(new TestInputFormat(new Path(inputPath))).addSink(new OutputFormatSinkFunction<>(new TestOutputFormat()));
