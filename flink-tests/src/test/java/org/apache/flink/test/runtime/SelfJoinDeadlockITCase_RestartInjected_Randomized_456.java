 ...
 */
public class SelfJoinDeadlockITCase_RestartInjected_Randomized_456 extends JavaProgramTestBaseJUnit4 {
    ...
    protected void testProgram() throws Exception {
        ...
        DataStreamSource<Tuple3<Integer, Integer, String>> ds = env.createInput(new LargeJoinDataGeneratorInputFormat(1000000));
        ds.join(ds).where(x -> x.f0).equalTo(x -> x.f1).window(GlobalWindows.createWithEndOfStreamTrigger()).apply(new Joiner()).sinkTo(FileSink.forRowFormat(new Path(resultPath), new SimpleStringEncoder<Tuple5<Integer, Integer, Integer, String, String>>()).build());
        JobClient jobClient = env.executeAsync("Local Selfjoin Test Job");
        Thread.sleep(2000);
