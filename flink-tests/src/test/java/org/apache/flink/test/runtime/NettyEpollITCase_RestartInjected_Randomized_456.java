 ...
 */
public class NettyEpollITCase_RestartInjected_Randomized_456 extends TestLogger {

    private static final Logger LOG = LoggerFactory.getLogger(NettyEpollITCase_RestartInjected.class);
    ...
    public void testNettyEpoll() throws Exception {
        ...
        try {
            ...
            JobClient jobClient = env.executeAsync("Netty Epoll Test");
