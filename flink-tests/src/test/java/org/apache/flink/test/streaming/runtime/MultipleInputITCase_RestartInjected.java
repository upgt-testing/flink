...
public class MultipleInputITCase_RestartInjected extends AbstractTestBaseJUnit4 {
    ...
    public void testNonKeyed(boolean withUnion) throws Exception {
        ...
        RestartFramework.at("during_multiple_input_processing")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testKeyedState() throws Exception {
        ...
        RestartFramework.at("during_keyed_state_processing")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
