 ...
 */
public class JobListenerITCase_RestartInjected_Randomized_123 extends TestLogger {
    ...
    public void testExecuteCallsJobListenerOnBatchEnvironment() throws Exception {
        ...
        RestartFramework.at("during_job_running").on(miniClusterResource).restart("taskmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
