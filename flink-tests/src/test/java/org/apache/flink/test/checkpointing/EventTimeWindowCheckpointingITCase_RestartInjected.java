...
public class EventTimeWindowCheckpointingITCase_RestartInjected extends TestLogger {
    ...
    public EventTimeWindowCheckpointingITCase_RestartInjected(StateBackendEnum stateBackendEnum) {
    ...
    public void testTumblingTimeWindow() throws Exception {
        ...
        RestartFramework.at("during_window_processing")
            .on(miniClusterResource)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
