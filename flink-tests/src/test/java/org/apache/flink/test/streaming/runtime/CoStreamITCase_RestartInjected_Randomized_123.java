...
public class CoStreamITCase_RestartInjected_Randomized_123 extends AbstractTestBaseJUnit4 {
    ...
    public void test() throws Exception {
        ...
        RestartFramework.at("during_costream_processing").on(MINI_CLUSTER_RESOURCE).restart("taskmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
