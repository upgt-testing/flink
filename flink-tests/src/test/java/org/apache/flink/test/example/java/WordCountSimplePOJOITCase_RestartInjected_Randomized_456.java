 ...
 */
public class WordCountSimplePOJOITCase_RestartInjected_Randomized_456 extends JavaProgramTestBaseJUnit4 implements Serializable {
    ...
    protected void testProgram() throws Exception {
        ...
        DataStream<WC> counts = text.flatMap(new Tokenizer()).keyBy(x -> x.word).window(GlobalWindows.createWithEndOfStreamTrigger()).reduce(new ReduceFunction<WC>() {
