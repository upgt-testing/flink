...
public class CoGroupJoinITCase_RestartInjected_Randomized_123 extends AbstractTestBaseJUnit4 {
    ...
    public void testCoGroup() throws Exception {
        ...
        RestartFramework.at("during_window_processing").on(MINI_CLUSTER_RESOURCE).restart("taskmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
        env.setParallelism(1);
        DataStream<Tuple2<String, Integer>> source1 = env.fromData(Tuple2.of("a", 0), Tuple2.of("a", 1), Tuple2.of("a", 2), Tuple2.of("b", 3), Tuple2.of("b", 4), Tuple2.of("b", 5), Tuple2.of("a", 6), Tuple2.of("a", 7), Tuple2.of("a", 8)).// source is finite, so it will have an implicit MAX
        ...
        DataStream<Tuple2<String, Integer>> source2 = env.fromData(Tuple2.of("a", 0), Tuple2.of("a", 1), Tuple2.of("b", 3), Tuple2.of("c", 6), Tuple2.of("c", 7), Tuple2.of("c", 8)).assignTimestampsAndWatermarks(new Tuple2TimestampExtractor());
        source1.coGroup(source2).where(new Tuple2KeyExtractor()).equalTo(new Tuple2KeyExtractor()).window(TumblingEventTimeWindows.of(Duration.ofMillis(3))).apply(new CoGroupFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, String>() {
        ...
        JobClient jobClient = env.executeAsync("CoGroup Test");
        Thread.sleep(1000);
    ...
    public void testJoin() throws Exception {
        ...
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        env.setParallelism(1);
        DataStream<Tuple3<String, String, Integer>> source1 = env.fromData(Tuple3.of("a", "x", 0), Tuple3.of("a", "y", 1), Tuple3.of("a", "z", 2), Tuple3.of("b", "u", 3), Tuple3.of("b", "w", 5), Tuple3.of("a", "i", 6), Tuple3.of("a", "j", 7), Tuple3.of("a", "k", 8)).assignTimestampsAndWatermarks(new Tuple3TimestampExtractor());
        DataStream<Tuple3<String, String, Integer>> source2 = env.fromData(Tuple3.of("a", "u", 0), Tuple3.of("a", "w", 1), Tuple3.of("b", "i", 3), Tuple3.of("b", "k", 5), Tuple3.of("a", "x", 6), Tuple3.of("a", "z", 8)).assignTimestampsAndWatermarks(new Tuple3TimestampExtractor());
        source1.join(source2).where(new Tuple3KeyExtractor()).equalTo(new Tuple3KeyExtractor()).window(TumblingEventTimeWindows.of(Duration.ofMillis(3))).apply(new JoinFunction<Tuple3<String, String, Integer>, Tuple3<String, String, Integer>, String>() {
        ...
        JobClient jobClient = env.executeAsync("Join Test");
        Thread.sleep(1000);
        jobClient.getJobExecutionResult().get();
        RestartFramework.at("during_window_processing").on(MINI_CLUSTER_RESOURCE).restart("taskmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    public void testSelfJoin() throws Exception {
        ...
        env.setParallelism(1);
        DataStream<Tuple3<String, String, Integer>> source1 = env.fromData(Tuple3.of("a", "x", 0), Tuple3.of("a", "y", 1), Tuple3.of("a", "z", 2), Tuple3.of("b", "u", 3), Tuple3.of("b", "w", 5), Tuple3.of("a", "i", 6), Tuple3.of("a", "j", 7), Tuple3.of("a", "k", 8)).assignTimestampsAndWatermarks(new Tuple3TimestampExtractor());
        source1.join(source1).where(new Tuple3KeyExtractor()).equalTo(new Tuple3KeyExtractor()).window(TumblingEventTimeWindows.of(Duration.ofMillis(3))).apply(new JoinFunction<Tuple3<String, String, Integer>, Tuple3<String, String, Integer>, String>() {
        ...
        JobClient jobClient = env.executeAsync("Self-Join Test");
        Thread.sleep(1000);
        jobClient.getJobExecutionResult().get();
    ...
    public void testCoGroupOperatorWithCheckpoint() throws Exception {
        ...
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        env.setParallelism(1);
        DataStream<Tuple2<String, Integer>> source1 = env.fromData(Tuple2.of("a", 0), Tuple2.of("b", 3));
        DataStream<Tuple2<String, Integer>> source2 = env.fromData(Tuple2.of("a", 1), Tuple2.of("b", 6));
        DataStream<String> coGroupWindow = source1.coGroup(source2).where(new Tuple2KeyExtractor()).equalTo(new Tuple2KeyExtractor()).window(TumblingEventTimeWindows.of(Duration.ofMillis(3))).apply(new CoGroupFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, String>() {
    ...
    private static class Tuple2TimestampExtractor implements WatermarkStrategyWithPunctuatedWatermarks<Tuple2<String, Integer>> {
    ...
    private static class Tuple3TimestampExtractor implements WatermarkStrategyWithPunctuatedWatermarks<Tuple3<String, String, Integer>> {
