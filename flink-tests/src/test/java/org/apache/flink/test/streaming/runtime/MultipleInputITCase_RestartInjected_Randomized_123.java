...
public class MultipleInputITCase_RestartInjected_Randomized_123 extends AbstractTestBaseJUnit4 {
    ...
    public void testNonKeyed(boolean withUnion) throws Exception {
        ...
        RestartFramework.at("during_multiple_input_processing").on(MINI_CLUSTER_RESOURCE).restart("taskmanager").withIndex(0).withMode(RestartMode.GRACEFUL).execute();
    ...
    private static class KeyedSumMultipleInputOperator extends AbstractStreamOperatorV2<Long> implements MultipleInputStreamOperator<Long> {
        ...
        public void initializeState(StateInitializationContext context) throws Exception {
            ...
            sumState = context.getKeyedStateStore().getState(new ValueStateDescriptor<>("sum-state", LongSerializer.INSTANCE));
        }

        @Override
        public List<Input> getInputs() {
            return Arrays.asList(new KeyedSumInput(this, 1), new KeyedSumInput(this, 2), new KeyedSumInput(this, 3));
        }
    ...
    public static class SumAllInputOperator extends AbstractStreamOperatorV2<Long> implements MultipleInputStreamOperator<Long> {
        ...
        public List<Input> getInputs() {
            ...
            return Arrays.<Input>asList(new SumInput<Integer>(this, 1), new SumInput<Long>(this, 2), new SumInput<String>(this, 3)).subList(0, numberOfInputs);
        }
