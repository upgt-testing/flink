...
public class WordCountSubclassInterfacePOJOITCase_RestartInjected_Randomized_456 extends JavaProgramTestBaseJUnit4 implements Serializable {
    ...
    protected void testProgram() throws Exception {
        ...
        DataStream<WCBase> counts = text.flatMap(new Tokenizer()).keyBy(x -> x.word).window(GlobalWindows.createWithEndOfStreamTrigger()).reduce(new ReduceFunction<WCBase>() {
        ...
        counts.sinkTo(FileSink.forRowFormat(new Path(resultPath), new SimpleStringEncoder<WCBase>()).build());
