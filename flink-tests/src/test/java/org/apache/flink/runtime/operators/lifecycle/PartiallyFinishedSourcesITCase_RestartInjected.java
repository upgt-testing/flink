...
public class PartiallyFinishedSourcesITCase_RestartInjected extends TestLogger {
    ...
    public void test() throws Exception {
        ...
        RestartFramework.at("before_partially_finished_execute")
        ...
        RestartFramework.at("during_partially_finished_execute")
            .on(miniClusterResource)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        executor = executor.sendOperatorCommand(finishingOperatorID, FINISH_SOURCES, subtaskScope)
