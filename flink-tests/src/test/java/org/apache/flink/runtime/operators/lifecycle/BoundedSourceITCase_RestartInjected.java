...
public class BoundedSourceITCase_RestartInjected extends TestLogger {
    ...
    public void test() throws Exception {
        ...
        RestartFramework.at("before_bounded_source_execute")
        ...
        TestJobExecutor executor = TestJobExecutor.execute(testJob, miniClusterResource)
                .waitForEvent(CheckpointCompletedEvent.class);

        RestartFramework.at("during_bounded_source_execute")
            .on(miniClusterResource)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
