...
public class StopWithSavepointITCase_RestartInjected extends AbstractTestBaseJUnit4 {
    ...
    public void test() throws Exception {
        ...
        RestartFramework.at("before_stop_with_savepoint_execute")
        ...
        TestJobExecutor executor = TestJobExecutor.execute(testJob, MINI_CLUSTER_RESOURCE)
                .waitForEvent(WatermarkReceivedEvent.class);

        RestartFramework.at("during_stop_with_savepoint_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
