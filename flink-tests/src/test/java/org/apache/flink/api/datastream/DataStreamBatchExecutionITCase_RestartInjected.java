 ...
 */
public class DataStreamBatchExecutionITCase_RestartInjected {
    ...
    public void batchFailoverWithKeyByBarrier() throws Exception {
        ...
        RestartFramework.at("before_batch_execute")
        ...
        try (CloseableIterator<String> result = mapped.executeAndCollect()) {
            ...
            RestartFramework.at("during_batch_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void batchReduceSingleResultPerKey() throws Exception {
        ...
        try (CloseableIterator<Long> sumsIterator = sums.executeAndCollect()) {
            ...
            RestartFramework.at("during_reduce_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void batchSumSingleResultPerKey() throws Exception {
        ...
        try (CloseableIterator<Long> sumsIterator = sums.executeAndCollect()) {
            ...
            RestartFramework.at("during_sum_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void batchKeyedNonKeyedTwoInputOperator() throws Exception {
        ...
        RestartFramework.at("before_two_input_execute")
            .on(miniClusterResource)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        try (CloseableIterator<String> resultIterator = result.executeAndCollect()) {
            ...
            RestartFramework.at("during_two_input_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void batchKeyedBroadcastExecution() throws Exception {
        ...
        RestartFramework.at("before_broadcast_execute")
            .on(miniClusterResource)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        try (CloseableIterator<String> resultIterator = result.executeAndCollect()) {
            ...
            RestartFramework.at("during_broadcast_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void batchMixedKeyedAndNonKeyedTwoInputOperator() throws Exception {
        ...
        RestartFramework.at("before_mixed_two_input_execute")
            .on(miniClusterResource)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        try (CloseableIterator<String> resultIterator = result.executeAndCollect()) {
            ...
            RestartFramework.at("during_mixed_two_input_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
    ...
    public void batchMixedKeyedAndNonKeyedMultiInputOperator() throws Exception {
        ...
        RestartFramework.at("before_multi_input_execute")
            .on(miniClusterResource)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        try (CloseableIterator<String> resultIterator = result.executeAndCollect()) {
            ...
            RestartFramework.at("during_multi_input_execution")
                .on(miniClusterResource)
                .restart("taskmanager")
                .withIndex(0)
                .withMode(RestartMode.GRACEFUL)
