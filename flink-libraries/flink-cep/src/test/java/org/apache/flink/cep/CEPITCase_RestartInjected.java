...
public class CEPITCase_RestartInjected extends AbstractTestBaseJUnit4 {
    ...
    public void testSimplePatternCEP() throws Exception {
        ...
        RestartFramework.at("before_cep_execute")
        ...
        RestartFramework.at("after_cep_pattern_match")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSimpleKeyedPatternCEP() throws Exception {
        ...
        RestartFramework.at("before_keyed_cep_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_keyed_pattern_match")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSimplePatternEventTime() throws Exception {
        ...
        RestartFramework.at("before_event_time_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_event_time_pattern")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSimpleKeyedPatternEventTime() throws Exception {
        ...
        RestartFramework.at("before_keyed_event_time_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_keyed_event_time_pattern")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSimplePatternWithSingleState() throws Exception {
        ...
        RestartFramework.at("before_single_state_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_single_state_pattern")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    private void testProcessingTimeWithWindow(WithinType withinType) throws Exception {
        ...
        RestartFramework.at("before_window_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_window_pattern")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
    ...
    public void testSimpleOrFilterPatternCEP() throws Exception {
        ...
        RestartFramework.at("before_or_filter_execute")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("jobmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
        ...
        RestartFramework.at("after_or_filter_pattern")
            .on(MINI_CLUSTER_RESOURCE)
            .restart("taskmanager")
            .withIndex(0)
            .withMode(RestartMode.GRACEFUL)
